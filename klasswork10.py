...
# print('{0} test {0} method format {1}' .format('red','blue'))
...
# url = r'c:\Users\Vlad\Downloads\home_list.zip'
...
# print('\t', work, '\t------>', work.istitle())
# print('\t', letDig, '\t------>', letDig.istitle())
# print('\t', '    ', '\t------>', '    '.istitle())
# print('\t', 'Lor Em', '\t------>', 'Lor Em'.istitle())
...
# print('\t', work, '\t------>', work.lower())
# print('\t', letDig, '\t------>', letDig.lower())
# print('\t', '    ', '\t------>', '    '.lower())
# print('\t', 'Lor Em', '\t------>', 'Lor Em'.lower())
...
# print('\t', work, '\t------>', work.upper())
# print('\t', letDig, '\t------>', letDig.upper())
# print('\t', '    ', '\t------>', '    '.upper())
# print('\t', 'Lor Em', '\t------>', 'Lor Em'.upper())
...
# print('\t', work, '\t------>', work.capitalize())
# print('\t', letDig, '\t------>', letDig.capitalize())
# print('\t', '    ', '\t------>', '    '.capitalize())
# print('\t', 'Lor Em', '\t------>', 'Lor Em'.capitalize())
...
# print('\t', work, '\t------>', work.swapcase())
# print('\t', letDig, '\t------>', letDig.swapcase())
# print('\t', '    ', '\t------>', '    '.swapcase())
# print('\t', 'Lor Em', '\t------>', 'Lor Em'.swapcase())
...
# # print('\t', line, '\t -----> ', line.index('ipsum', 0, 23))
# # print('\t', line, '\t -----> ', line.index('ipsum', 0, 12))
# # print('\t', line, '\t -----> ', line.index('ipsum', 0, 0))
